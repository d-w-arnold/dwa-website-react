            ...
            <div className="body">
                    ...
                    <table className="marginBottom2">
                        <tr>
                            <td className="employerName"><span className="iconUni" aria-hidden="true"/><b><a
                                target="_blank" href={uni_of_kent}>University of Kent</a></b></td>
                ...
                <div className="roboto">
                    <table className="marginBottom2">
                        <tr>
                            <td className="employerName"><span className="iconUni" aria-hidden="true"/><b><a
                                target="_blank" href={newberry}>Newberry College</a></b></td>
                ...
                <div className="roboto">
                    <table className="marginBottom2">
                        <tr>
                            <td className="employerName"><span className="iconUni" aria-hidden="true"/><b><a
                                target="_blank" href={open_uni}>The Open University</a></b></td>
                ...
                <div className="roboto">
                    <table className="marginBottom2">
                        <tr>
                            <td className="employerName"><span className="iconUni" aria-hidden="true"/><b><a
                                target="_blank" href={harvey}>The Harvey Grammar School</a></b>
                            </td>
